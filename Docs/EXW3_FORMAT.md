...
EXW3 uses two custom domain-specific languages:

- **`.exwl3`** - Layer definition files with CSS, HTML, and JavaScript
- **`.exws3`** - Section definition files that combine HTML, CSS, and JavaScript

Both are custom text formats (not JSON) designed for easy authoring and readability.
...
- Use lowercase: `my-section.exws3`, `my-layer.exwl3`
- Use hyphens for spaces: `my-custom-section.exws3`
- Match the `@name` field: `@name "my-section"` → `my-section.exws3`
